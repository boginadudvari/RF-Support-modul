...
public partial class MyDnndatabaseContext : DbContext
{
    ...
    public virtual DbSet<AnnouncementsSubscriber> AnnouncementsSubscribers { get; set; }
    ...
    public virtual DbSet<MakeYourMealItem> MakeYourMealItems { get; set; }
    ...
    public virtual DbSet<UserDefinedDatum> UserDefinedData { get; set; }

    public virtual DbSet<UserDefinedField> UserDefinedFields { get; set; }

    public virtual DbSet<UserDefinedFieldSetting> UserDefinedFieldSettings { get; set; }

    public virtual DbSet<UserDefinedRow> UserDefinedRows { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=rendfejl1019;Initial Catalog=MyDNNDatabase;Integrated Security=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Announcement>(entity =>
        {
            ...
            entity.Property(e => e.ImageSource).HasMaxLength(250);
            ...
            entity.HasOne(d => d.Module).WithMany(p => p.Announcements)
                .HasForeignKey(d => d.ModuleId)
                .HasConstraintName("FK_Announcements_Modules");
        });

        modelBuilder.Entity<AnnouncementsSubscriber>(entity =>
        {
            entity.Property(e => e.AnnouncementsSubscriberId).HasColumnName("AnnouncementsSubscriberID");
            entity.Property(e => e.CreatedByUserId).HasColumnName("CreatedByUserID");
            entity.Property(e => e.CreatedOnDate).HasColumnType("datetime");
            entity.Property(e => e.LastModifiedByUserId).HasColumnName("LastModifiedByUserID");
            entity.Property(e => e.LastModifiedOnDate).HasColumnType("datetime");
            ...
            entity.HasOne(d => d.Module).WithMany(p => p.AnnouncementsSubscribers)
                .HasForeignKey(d => d.ModuleId)
                .HasConstraintName("FK_AnnouncementsSubscribers_Modules");

            entity.HasOne(d => d.User).WithMany(p => p.AnnouncementsSubscribers)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK_AnnouncementsSubscribers_Users");
        });
        ...
        modelBuilder.Entity<AspnetApplication>(entity =>
        {
            entity.HasKey(e => e.ApplicationId)
                .HasName("PK__aspnet_A__C93A4C982F0D0249")
                .IsClustered(false);

            entity.ToTable("aspnet_Applications");

            entity.HasIndex(e => e.LoweredApplicationName, "UQ__aspnet_A__17477DE462DE5365").IsUnique();

            entity.HasIndex(e => e.ApplicationName, "UQ__aspnet_A__3091033103D1F4A7").IsUnique();
        ...
        modelBuilder.Entity<AspnetMembership>(entity =>
        {
            entity.HasKey(e => e.UserId)
                .HasName("PK__aspnet_M__1788CC4DE753F14F")
                .IsClustered(false);
        ...
        {
            entity.HasKey(e => new { e.Feature, e.CompatibleSchemaVersion }).HasName("PK__aspnet_S__5A1E6BC1B765D96C");
        ...
        {
            entity.HasKey(e => e.UserId)
                .HasName("PK__aspnet_U__1788CC4DEA159CC8")
                .IsClustered(false);
        ...
        modelBuilder.Entity<HccProduct>(entity =>
        {
            ...
            entity.Property(e => e.GiftWrapPrice).HasColumnType("numeric(18, 10)");
            entity.Property(e => e.Id).ValueGeneratedOnAdd();
        ...
        modelBuilder.Entity<List>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.PortalId, e.ListName, e.Value, e.Text, e.ParentId }, "IX_Lists_ListName_Value_Text_ParentID").IsUnique();

            entity.HasIndex(e => new { e.PortalId, e.ParentId, e.ListName, e.Value }, "IX_Lists_ParentID").IsUnique();
        ...
        modelBuilder.Entity<MakeYourMealItem>(entity =>
        {
            entity.HasKey(e => e.ItemId);

            entity.ToTable("MakeYourMeal_Items");
        ...
        {
            entity.HasKey(e => e.SubscriberId).HasName("PK__Newslett__7DFEB63499D7DBAF");
        ...
        modelBuilder.Entity<Tab>(entity =>
        {
            ...
            entity.Property(e => e.PortalId).HasColumnName("PortalID");
            entity.Property(e => e.SiteMapPriority).HasDefaultValue(0.5);
        ...
        modelBuilder.Entity<UserDefinedDatum>(entity =>
        {
            entity.HasKey(e => new { e.UserDefinedFieldId, e.UserDefinedRowId });

            entity.HasOne(d => d.UserDefinedField).WithMany(p => p.UserDefinedData)
                .HasForeignKey(d => d.UserDefinedFieldId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_UserDefinedData_UserDefinedFields");

            entity.HasOne(d => d.UserDefinedRow).WithMany(p => p.UserDefinedData)
                .HasForeignKey(d => d.UserDefinedRowId)
                .HasConstraintName("FK_UserDefinedData_UserDefinedRows");
        });

        modelBuilder.Entity<UserDefinedField>(entity =>
        {
            entity.HasKey(e => e.UserDefinedFieldId).HasName("PK_UserDefinedTable");

            entity.HasIndex(e => new { e.ModuleId, e.FieldOrder }, "IX_UserDefinedFields").IsUnique();

            entity.Property(e => e.Default)
                .HasMaxLength(2000)
                .HasDefaultValue("");
            entity.Property(e => e.EditStyle).HasMaxLength(512);
            entity.Property(e => e.FieldTitle).HasMaxLength(2000);
            entity.Property(e => e.FieldType)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.OutputSettings)
                .HasMaxLength(2000)
                .HasDefaultValue("");
            entity.Property(e => e.ShowOnEdit).HasDefaultValue(true);
            entity.Property(e => e.ValidationMessage).HasMaxLength(512);
            entity.Property(e => e.ValidationRule).HasMaxLength(512);

            entity.HasOne(d => d.Module).WithMany(p => p.UserDefinedFields)
                .HasForeignKey(d => d.ModuleId)
                .HasConstraintName("FK_UserDefinedFields_Modules");
        });

        modelBuilder.Entity<UserDefinedFieldSetting>(entity =>
        {
            entity.HasKey(e => new { e.FieldId, e.SettingName });

            entity.Property(e => e.SettingName).HasMaxLength(50);

            entity.HasOne(d => d.Field).WithMany(p => p.UserDefinedFieldSettings)
                .HasForeignKey(d => d.FieldId)
                .HasConstraintName("FK_UserDefinedFieldSettings_UserDefinedFields");
        });

        modelBuilder.Entity<UserDefinedRow>(entity =>
        {
            entity.HasIndex(e => new { e.ModuleId, e.CreatedAt }, "IX_UserDefinedRows");

            entity.Property(e => e.CreatedAt).HasColumnType("datetime");

            entity.HasOne(d => d.Module).WithMany(p => p.UserDefinedRows)
                .HasForeignKey(d => d.ModuleId)
                .HasConstraintName("FK_UserDefinedRows_Modules");
        });
